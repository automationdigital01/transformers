...
def main():
    ...
    #keywords to search
    keyword=st.sidebar.multiselect('Select a keyword to search',
                                   ['Hydrocarbons',
                                    'Mass balance',
                                    'Polymerization',
                                    'Pyrolysis',
    ...
    if option and keyword and st.sidebar.button("Submit"):
        ...
        for URL in valid_urls:
            ...
            #st.write(title)
            text = soup.get_text()
            if words_in_string(keyword, text) or words_in_string(keyword, text):
                st.write(URL)
